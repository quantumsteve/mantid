...
public:
  ...
  void testExec() {
    ...
    TS_ASSERT_THROWS_NOTHING(
        setmat->setPropertyValue("SampleNumberDensity", "0.0236649"));
    TS_ASSERT_THROWS_NOTHING(
        setmat->setPropertyValue("ScatteringXSection", "15.7048"));
    TS_ASSERT_THROWS_NOTHING(
        setmat->setPropertyValue("AttenuationXSection", "0.46257"));
    ...
    TS_ASSERT_DELTA(
        ...
        15.7048, 0.0001);
    TS_ASSERT_DELTA(
        m_sampleMaterial->absorbXSection(NeutronAtom::ReferenceLambda), 0.46257,
        0.0001);
