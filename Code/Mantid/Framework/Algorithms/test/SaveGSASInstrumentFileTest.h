...
public:
  ...
  void loadProfileTable(string wsname) {
    ...
    parnames.push_back("BANK");
    parvalues.push_back(1.);
    parnames.push_back("Alph0");
    parvalues.push_back(0.5);
    parnames.push_back("Alph0t");
    parvalues.push_back(65.14);
    parnames.push_back("Alph1");
    parvalues.push_back(8.15);
    parnames.push_back("Alph1t");
    parvalues.push_back(0);
    parnames.push_back("Beta0");
    parvalues.push_back(3.201);
    parnames.push_back("Beta0t");
    parvalues.push_back(78.412);
    parnames.push_back("Beta1");
    parvalues.push_back(7.674);
    parnames.push_back("Beta1t");
    parvalues.push_back(0);
    parnames.push_back("Dtt1");
    parvalues.push_back(22780.57);
    parnames.push_back("Dtt1t");
    parvalues.push_back(22790.129);
    parnames.push_back("Dtt2");
    parvalues.push_back(0);
    parnames.push_back("Dtt2t");
    parvalues.push_back(0.3);
    parnames.push_back("Gam0");
    parvalues.push_back(0);
    parnames.push_back("Gam1");
    parvalues.push_back(0);
    parnames.push_back("Gam2");
    parvalues.push_back(0);
    parnames.push_back("Sig0");
    parvalues.push_back(0);
    parnames.push_back("Sig1");
    parvalues.push_back(sqrt(10.0));
    parnames.push_back("Sig2");
    parvalues.push_back(sqrt(403.30));
    parnames.push_back("Tcross");
    parvalues.push_back(0.3560);
    parnames.push_back("Width");
    parvalues.push_back(1.2141);
    parnames.push_back("Zero");
    parvalues.push_back(0);
    parnames.push_back("Zerot");
    parvalues.push_back(-70.60);
    parnames.push_back("step");
    parvalues.push_back(5);
    parnames.push_back("tof-max");
    parvalues.push_back(46760);
    parnames.push_back("tof-min");
    parvalues.push_back(2278.06);
    parnames.push_back("twotheta");
    parvalues.push_back(90.807);
    parnames.push_back("CWL");
