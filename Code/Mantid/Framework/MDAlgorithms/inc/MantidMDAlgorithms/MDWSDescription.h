...
protected: // until MDWSDesctiptionDepricatedExist
  ...
  /// workspace.
  /// Calculated from number of input properties and the operations, performed
  /// on input workspace;
  ...
  /// the names for the target workspace dimensions and properties of input MD
  /// workspace
  std::vector<std::string> m_DimNames;
  /// the ID-s for the target workspace, which allow to identify the dimensions
  /// according to their ID
  std::vector<std::string> m_DimIDs;
  /// the units of target workspace dimensions and properties of input MD
  /// workspace dimensions
  std::vector<std::string> m_DimUnits;
  /// if defined, specifies number of bins split in each dimension
  std::vector<size_t> m_NBins;
  /// minimal and maximal values for the workspace dimensions. Usually obtained
  /// from WS parameters;
