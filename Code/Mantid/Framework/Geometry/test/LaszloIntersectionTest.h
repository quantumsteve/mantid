...
public:
  ...
  void test_Shapes_Sharing_A_Line_Throws() {
     ...
     */
    TS_ASSERT_THROWS(intersectionByLaszlo(rect2, parallelogram),
                     Mantid::Geometry::NoIntersectionException);
    TS_ASSERT_THROWS(intersectionByLaszlo(parallelogram, rect2),
                     Mantid::Geometry::NoIntersectionException);
  }
  ...
  void test_No_Overlap_At_All_Throws_NoIntersectionException() {
    ...
    ConvexPolygon squareOne(0.0, 2.0, 0.0,
                            2.0); // 2x2, bottom left-hand corner at origin
    ConvexPolygon squareTwo(3.0, 5.0, 3.0,
                            5.0); // 2x2, bottom left-hand corner at (3,3)

    TS_ASSERT_THROWS(intersectionByLaszlo(squareOne, squareTwo),
                     Mantid::Geometry::NoIntersectionException);
    TS_ASSERT_THROWS(intersectionByLaszlo(squareTwo, squareOne),
                     Mantid::Geometry::NoIntersectionException);
  }
};
